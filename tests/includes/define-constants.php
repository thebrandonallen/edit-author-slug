...
define( 'BA_EAS_PLUGIN_DIR', dirname( dirname( dirname( __FILE__ ) ) ) );

if ( ! defined( 'BA_EAS_TESTS_DIR' ) ) {
	define( 'BA_EAS_TESTS_DIR', dirname( dirname( __FILE__ ) ) );
}
 ...
 */
if ( false !== getenv( 'WP_PHPUNIT__DIR' ) && defined( 'BA_EAS_USE_WP_ENV_TESTS' ) ) {
	...
	if ( false !== getenv( 'WP_DEVELOP_DIR' ) ) {
		...
		define( 'WP_ROOT_DIR', dirname( dirname( dirname( dirname( dirname( dirname( dirname( __FILE__ ) ) ) ) ) ) ) );
	}
